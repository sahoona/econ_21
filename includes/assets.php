...
function gp_child_enqueue_assets() {
    ...
    wp_enqueue_style('gp-main-style',
        get_stylesheet_directory_uri() . '/assets/css/main.css',
        ['gp-child-style'],
        file_exists($theme_dir . '/assets/css/main.css') ? filemtime($theme_dir . '/assets/css/main.css') : $theme_version
    );
    ...
    // Conditional CSS loading has been removed as all styles are now merged into main.css
